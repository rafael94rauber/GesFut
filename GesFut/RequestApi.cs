...
namespace GesFut
{
    public class RequestApi
    {
        ...
        public  async Task<Uri> AtualizarAvaliacao(AvaliacaoDesempenho avaliacao)
        {
            client.BaseAddress = new Uri("https://localhost:44313/");
            client.DefaultRequestHeaders.Accept.Clear();
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            HttpResponseMessage response = await client.PostAsJsonAsync("AvaliacaoDesempenhoController/InserirAvaliacao", avaliacao);
